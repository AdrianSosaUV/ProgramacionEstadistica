...
\hypersetup{
  pdftitle={Programación Estadística},
  pdfauthor={Ing. Adrián Sosa},
  hidelinks,
...
\hypertarget{curso-de-nivelaciuxf3n}{%
\section{Curso de nivelación}\label{curso-de-nivelaciuxf3n}}

\hypertarget{tipos-de-datos}{%
\subsection{Tipos de datos}\label{tipos-de-datos}}

Exsisten diferentes tipos de datos dentro de los lenguajes de
...
\includegraphics{Tipos-de-Datos_files/figure-latex/pressure-1.pdf}
